...
\begin{ltxtable}{width}
\begin{ltxtable}[alignment]{width}
\begin{math}
\begin{matrix}
...
\begin{Bmatrix}
\begin{Bverbatim}
\begin{Bverbatim}[option]
\begin{Lverbatim}
\begin{Lverbatim}[option]
\begin{Vmatrix}
\end{abstract}
\end{align}
\end{align*}
