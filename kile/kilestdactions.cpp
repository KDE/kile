...
void setupStdTags(KileInfoInterface *kii, KMainWindow *parent, QPtrList<KAction>* plist, QStringList* labelitem )
{
	...
	(void) new KileAction::Tag("\\medskip",  0, parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_medskip","\\medskip ",QString::null,9,0,i18n("The \\medskip command adds a 'medium' vertical space."));
  	...
  	(void) new KileAction::InputTag(kii,"\\includegraphics{file.eps}",0, parent, SLOT(insertGraphic(const KileAction::TagData&)), parent->actionCollection(),"tag_includegraphics", parent, KileAction::KeepHistory | KileAction::ShowBrowseButton, "\\includegraphics[scale=1]{%R","}", 26,0, i18n( "This command is used to import image files (\\usepackage{graphicx} is required)\nExamples :\n\\includegraphics{file} ; \\includegraphics[width=10cm]{file} ; \\includegraphics*[scale=0.75]{file}"), i18n("Type or select a filename: "));
	(void) new KileAction::InputTag(kii,"\\include{file}","include",0 , parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_include",parent, KileAction::KeepHistory | KileAction::ShowBrowseButton, "\\include{%R","}",9,0, i18n("\\include{file}\nThe \\include command is used in conjunction with the \\includeonly command for selective inclusion of files."),i18n("Type or select a filename: "));
	(void) new KileAction::InputTag(kii,"\\input{file}","include",0 , parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_input", parent, KileAction::KeepHistory | KileAction::ShowBrowseButton, "\\input{%R","}",7,0,i18n("\\input{file}\nThe \\input command causes the indicated file to be read and processed, exactly as if its contents had been inserted in the current file at that point."),i18n("Type or select a filename: "));
	...
	alist.append(new KileAction::InputTag(kii,"part","part",0 , parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_part", parent, KileAction::ShowAlternative | KileAction::KeepHistory, "\\part%A{%R}","\n", 0,1,i18n("\\part{title}\n\\part*{title} : do not include a number and do not make an entry in the table of contents\n"), i18n("Part"),0,i18n("No numbering")));
	alist.append(new KileAction::InputTag(kii,"chapter","chapter",0 , parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_chapter" ,parent, KileAction::ShowAlternative | KileAction::KeepHistory, "\\chapter%A{%R}","\n", 0,1,i18n("\\chapter{title}\n\\chapter*{title} : do not include a number and do not make an entry in the table of contents\nOnly for 'report' and 'book' class document."), i18n("Chapter"),0,i18n("No numbering")));
	alist.append(new KileAction::InputTag(kii,"section","section",0 , parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_section",parent, KileAction::ShowAlternative | KileAction::KeepHistory, "\\section%A{%R}","\n", 0,1,i18n("\\section{title}\n\\section*{title} : do not include a number and do not make an entry in the table of contents"), i18n("Section"),0,i18n("No numbering")));
	alist.append(new KileAction::InputTag(kii,"subsection","subsection",0 , parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_subsection" ,parent, KileAction::ShowAlternative | KileAction::KeepHistory, "\\subsection%A{%R}","\n", 0,1,i18n("\\subsection{\n\\subsection{title}\n\\subsection*{title} : do not include a number and do not make an entry in the table of contents"), i18n("Subsection"),0,i18n("No numbering")));
	alist.append(new KileAction::InputTag(kii,"subsubsection","subsubsection",0 , parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_subsubsection",parent, KileAction::ShowAlternative | KileAction::KeepHistory, "\\subsubsection%A{%R}","\n", 0,1,i18n("\\subsubsection{title}\n\\subsubsection*{title} : do not include a number and do not make an entry in the table of contents"), i18n("Subsubsection"),0,i18n("No numbering")));
	alist.append(new KileAction::InputTag(kii,"paragraph",0, parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_paragraph",parent, KileAction::ShowAlternative | KileAction::KeepHistory, "\\paragraph%A{%R}","\n", 0,1,i18n("\\paragraph{title}\n\\paragraph*{title} : do not include a number and do not make an entry in the table of contents"), i18n("Paragraph"),0,i18n("No numbering")));
	alist.append(new KileAction::InputTag(kii,"subparagraph",0, parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_subparagraph",parent, KileAction::ShowAlternative | KileAction::KeepHistory, "\\part%A{%R}","\n", 0,1,i18n("\\subparagraph{title}\n\\subparagraph*{title} : do not include a number and do not make an entry in the table of contents"), i18n("Subparagraph"),0,i18n("No numbering")));
	...
	alist.append(new KileAction::InputTag(kii,"ref",0, parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_ref", parent, KileAction::FromList, "\\ref{%R","}", 5,0, QString::null, i18n("Label"), labelitem  ));
	alist.append(new KileAction::InputTag(kii,"pageref",0, parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_pageref", parent, KileAction::FromList, "\\pageref{%R","}", 9,0, QString::null, i18n("Label"), labelitem  ));
	alist.append(new KileAction::InputTag(kii,"cite",0, parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_cite", parent, KileAction::KeepHistory, "\\cite{%R","}", 6,0, i18n("This command generates an in-text citation to the reference associated with the ref entry in the bib file\nYou can open the bib file with Kile to see all the available references"), i18n("Reference")));
...
void setupMathTags(KMainWindow *parent, QPtrList<KAction>* plist)
{
	...
	(void) new KileAction::Tag("small",  0, parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_space_small", "\\,", QString::null, 2);
	(void) new KileAction::Tag("medium", 0, parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_space_medium", "\\:", QString::null,2);
	(void) new KileAction::Tag("large",  0, parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_space_large", "\\;", QString::null,2);
