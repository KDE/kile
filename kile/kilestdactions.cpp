...
void setupStdTags(KileInfoInterface *kii, KMainWindow *parent, QPtrList<KAction>* plist )
{
	...
	alist.append(new KileAction::InputTag(kii,"ref",0, parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_ref", parent, KileAction::FromLabelList, "\\ref{%R","}", 5,0, QString::null, i18n("Label") ));
	alist.append(new KileAction::InputTag(kii,"pageref",0, parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_pageref", parent, KileAction::FromLabelList, "\\pageref{%R","}", 9,0, QString::null, i18n("Label") ));
