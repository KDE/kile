...
void setupStdTags(KMainWindow *parent, QPtrList<KAction>* plist, QStringList* labelitem )
{
	...
	alist.append(new KileAction::InputTag("part","part",0 , parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_part", parent, KileAction::ShowAlternative | KileAction::KeepHistory, "\\part%A{%R}","\n", 0,1,i18n("\\part{title}\n\\part*{title} : do not include a number and do not make an entry in the table of contents\n"), i18n("Part"),0,i18n("No numbering")));
	alist.append(new KileAction::InputTag("chapter","chapter",0 , parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_chapter" ,parent, KileAction::ShowAlternative | KileAction::KeepHistory, "\\chapter%A{%R}","\n", 0,1,i18n("\\chapter{title}\n\\chapter*{title} : do not include a number and do not make an entry in the table of contents\nOnly for 'report' and 'book' class document."), i18n("Chapter"),0,i18n("No numbering")));
	alist.append(new KileAction::InputTag("section","section",0 , parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_section",parent, KileAction::ShowAlternative | KileAction::KeepHistory, "\\section%A{%R}","\n", 0,1,i18n("\\section{title}\n\\section*{title} : do not include a number and do not make an entry in the table of contents"), i18n("Section"),0,i18n("No numbering")));
	alist.append(new KileAction::InputTag("subsection","subsection",0 , parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_subsection" ,parent, KileAction::ShowAlternative | KileAction::KeepHistory, "\\subsection%A{%R}","\n", 0,1,i18n("\\subsection{\n\\subsection{title}\n\\subsection*{title} : do not include a number and do not make an entry in the table of contents"), i18n("Subsection"),0,i18n("No numbering")));
	alist.append(new KileAction::InputTag("subsubsection","subsubsection",0 , parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_subsubsection",parent, KileAction::ShowAlternative | KileAction::KeepHistory, "\\subsubsection%A{%R}","\n", 0,1,i18n("\\subsubsection{title}\n\\subsubsection*{title} : do not include a number and do not make an entry in the table of contents"), i18n("Subsubsection"),0,i18n("No numbering")));
	alist.append(new KileAction::InputTag("paragraph",0, parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_paragraph",parent, KileAction::ShowAlternative | KileAction::KeepHistory, "\\paragraph%A{%R}","\n", 0,1,i18n("\\paragraph{title}\n\\paragraph*{title} : do not include a number and do not make an entry in the table of contents"), i18n("Paragraph"),0,i18n("No numbering")));
	alist.append(new KileAction::InputTag("subparagraph",0, parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_subparagraph",parent, KileAction::ShowAlternative | KileAction::KeepHistory, "\\part%A{%R}","\n", 0,1,i18n("\\subparagraph{title}\n\\subparagraph*{title} : do not include a number and do not make an entry in the table of contents"), i18n("Subparagraph"),0,i18n("No numbering")));
	...
	alist.append(new KileAction::InputTag("ref",0, parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_ref", parent, KileAction::FromList, "\\ref{%R","}", 5,0, QString::null, i18n("Label"), labelitem  ));
	alist.append(new KileAction::InputTag("pageref",0, parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_pageref", parent, KileAction::FromList, "\\pageref{%R","}", 9,0, QString::null, i18n("Label"), labelitem  ));
	alist.append(new KileAction::InputTag("cite",0, parent, SLOT(insertTag(const KileAction::TagData&)), parent->actionCollection(),"tag_cite", parent, KileAction::KeepHistory, "\\cite{%R","}", 6,0, i18n("This command generates an in-text citation to the reference associated with the ref entry in the bib file\nYou can open the bib file with Kile to see all the available references"), i18n("Reference")));
