...
public:
    ...
    void setMenutype(UserMenuData::MenuType type) {
        m_data.menutype = type;
    }
    UserMenuData::MenuType menutype() {
        return m_data.menutype;
    }

    void setMenutitle(const QString &s) {
        m_data.menutitle = s;
    }
    const QString &menutitle() {
        return m_data.menutitle;
    }

    void setMenuicon(const QString &icon) {
        m_data.icon = icon;
    }
    QString menuicon() {
        return m_data.icon;
    ...
    // checkboxes
    void setNeedsSelection(bool state) {
        m_data.needsSelection = state;
    }
    bool needsSelection() {
        return m_data.needsSelection;
    }

    void setUseContextMenu(bool state) {
        m_data.useContextMenu = state;
    }
    bool useContextMenu() {
        return m_data.useContextMenu;
    }

    void setReplaceSelection(bool state) {
        m_data.replaceSelection = state;
    }
    bool replaceSelection() {
        return m_data.replaceSelection;
    }

    void setSelectInsertion(bool state) {
        m_data.selectInsertion = state;
    }
    bool selectInsertion() {
        return m_data.selectInsertion;
    }

    void setInsertOutput(bool state) {
        m_data.insertOutput = state;
    }
    bool insertOutput() {
        return m_data.insertOutput;
    }
