...
// advanced editor (dani)
    createAction(i18n("Environment (inside)"), "edit_select_inside_env", "selenv_i", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_S, Qt::Key_E),
                 m_edit, &KileDocument::EditorExtension::selectEnvInside);
    createAction(i18n("Environment (outside)"), "edit_select_outside_env", "selenv_o", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_S, Qt::Key_F),
                 m_edit, &KileDocument::EditorExtension::selectEnvOutside);
    createAction(i18n("TeX Group (inside)"), "edit_select_inside_group", "selgroup_i", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_S, Qt::Key_T),
                 m_edit, &KileDocument::EditorExtension::selectTexgroupInside);
    createAction(i18n("TeX Group (outside)"), "edit_select_outside_group", "selgroup_o", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_S, Qt::Key_U),
                 m_edit, &KileDocument::EditorExtension::selectTexgroupOutside);
    createAction(i18n("Math Group"), "edit_select_mathgroup", "selmath", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_S, Qt::Key_M),
                 m_edit, [this]() { m_edit->selectMathgroup(); });
    createAction(i18n("Paragraph"), "edit_select_paragraph", "selpar", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_S, Qt::Key_P),
                 m_edit, [this]() { m_edit->selectParagraph(); });
    createAction(i18n("Line"), "edit_select_line", "selline", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_S, Qt::Key_L),
                 m_edit, [this]() { m_edit->selectLine(); });
    createAction(i18n("TeX Word"), "edit_select_word", "selword", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_S, Qt::Key_W),
                 m_edit, [this]() { m_edit->selectWord(); });

    createAction(i18n("Environment (inside)"), "edit_delete_inside_env", "delenv_i", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_T, Qt::Key_E),
                 m_edit, &KileDocument::EditorExtension::deleteEnvInside);
    createAction(i18n("Environment (outside)"), "edit_delete_outside_env", "delenv_o", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_T, Qt::Key_F),
                 m_edit, &KileDocument::EditorExtension::deleteEnvOutside);
    createAction(i18n("TeX Group (inside)"), "edit_delete_inside_group", "delgroup_i", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_T, Qt::Key_T),
                 m_edit, &KileDocument::EditorExtension::deleteTexgroupInside);
    createAction(i18n("TeX Group (outside)"), "edit_delete_outside_group", "delgroup_o",QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_T, Qt::Key_U),
                 m_edit, &KileDocument::EditorExtension::deleteTexgroupInside);
    createAction(i18n("Math Group"), "edit_delete_mathgroup", "delmath", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_T, Qt::Key_M),
                 m_edit, [this]() { m_edit->deleteMathgroup(); });
    createAction(i18n("Paragraph"), "edit_delete_paragraph", "delpar", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_T, Qt::Key_P),
                 m_edit, [this]() { m_edit->deleteParagraph(); });
    createAction(i18n("To End of Line"), "edit_delete_eol", "deleol", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_T, Qt::Key_L),
                 m_edit, [this]() { m_edit->deleteEndOfLine(); });
    createAction(i18n("TeX Word"), "edit_delete_word", "delword", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_T, Qt::Key_W),
                 m_edit, [this]() { m_edit->deleteWord(); });

    createAction(i18n("Go to Begin"), "edit_begin_env", "gotobeginenv", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_E, Qt::Key_B),
                 m_edit, &KileDocument::EditorExtension::gotoBeginEnv);
    createAction(i18n("Go to End"), "edit_end_env", "gotoendenv", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_E, Qt::Key_E),
                 m_edit, &KileDocument::EditorExtension::gotoEndEnv);
    createAction(i18n("Match"), "edit_match_env", "matchenv", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_E, Qt::Key_M),
                 m_edit, &KileDocument::EditorExtension::matchEnv);
    createAction(i18n("Close"), "edit_close_env", "closeenv", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_E, Qt::Key_C),
                 m_edit, &KileDocument::EditorExtension::closeEnv);
    createAction(i18n("Close All"), "edit_closeall_env", "closeallenv", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_E, Qt::Key_A),
                 m_edit, &KileDocument::EditorExtension::closeAllEnv);

    createAction(i18n("Go to Begin"), "edit_begin_group", "gotobegingroup", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_G, Qt::Key_B),
                 m_edit, &KileDocument::EditorExtension::gotoBeginTexgroup);
    createAction(i18n("Go to End"), "edit_end_group", "gotoendgroup", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_G, Qt::Key_E),
                 m_edit, &KileDocument::EditorExtension::gotoEndTexgroup);
    createAction(i18n("Match"), "edit_match_group", "matchgroup", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_G, Qt::Key_M),
                 m_edit, [this]() { m_edit->matchTexgroup(); });
    createAction(i18n("Close"), "edit_close_group", "closegroup", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_G, Qt::Key_C),
                 m_edit, [this]() { m_edit->closeTexgroup(); });

    createAction(i18n("Selection"), "quickpreview_selection", "preview_sel", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_P, Qt::Key_S), this, &Kile::quickPreviewSelection);
    createAction(i18n("Environment"), "quickpreview_environment", "preview_env",QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_P, Qt::Key_E), this, &Kile::quickPreviewEnvironment);
    createAction(i18n("Subdocument"), "quickpreview_subdocument", "preview_subdoc",QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_P, Qt::Key_D), this, &Kile::quickPreviewSubdocument);
    createAction(i18n("Mathgroup"), "quickpreview_math", "preview_math", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_P, Qt::Key_M), this, &Kile::quickPreviewMathgroup);
    ...
    createAction(i18n("LaTeX"), "help_latex_index", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_H, Qt::Key_L),
                 m_help, &KileHelp::Help::helpLatexIndex);
    createAction(i18n("LaTeX Commands"), "help_latex_command", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_H, Qt::Key_C),
                 m_help, &KileHelp::Help::helpLatexCommand);
    createAction(i18n("LaTeX Environments"), "help_latex_env", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_H, Qt::Key_E),
                 m_help, &KileHelp::Help::helpLatexEnvironment);
    createAction(i18n("Context Help"), "help_context", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_H, Qt::Key_K),
                 m_help, [this]() { m_help->helpKeyword(); });
    createAction(i18n("Documentation Browser"), "help_docbrowser", QKeySequence(Qt::CTRL | Qt::ALT | Qt::Key_H, Qt::Key_B),
