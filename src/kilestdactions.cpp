...
void setupStdTags(KileInfo *ki, const QObject* receiver, KActionCollection *actionCollection, QWidget *parentWidget)
{
	...
	(void) new KileAction::Tag(i18n("Table of Contents - \\tableofcontents"), i18n("Table of Contents"), KShortcut(), receiver, SLOT(insertTag(const KileAction::TagData&)), actionCollection,"tag_tableofcontents","\\tableofcontents",QString(),16,0,i18n("Put this command where you want the table of contents to go"));
	...
	(void) new KileAction::Tag(i18n("Table - \\begin{table}"), i18n("Table"), "frame_spreadsheet", KShortcut(), receiver, SLOT(insertTag(const KileAction::TagData&)), actionCollection,"tag_table","\\begin{table}\n","%E\n\\caption{}\n\\end{table} ",0,1,
	...
	(void) new KileAction::Tag(i18n("Figure - \\begin{figure}"), i18n("Figure"), "frame_image", KShortcut(), receiver, SLOT(insertTag(const KileAction::TagData&)), actionCollection,"tag_figure" ,"\\begin{figure}\n","%E\n\\caption{}\n\\end{figure} ",0,1,
...
void setupMathTags(const QObject *receiver, KActionCollection *actionCollection)
{
	...
	(void) new KileAction::Tag(i18n("Square Root - \\sqrt{}"), i18n("Square Root"), "math_sqrt", KShortcut(Qt::ALT+Qt::SHIFT+Qt::Key_S), receiver, SLOT(insertTag(const KileAction::TagData&)), actionCollection,"tag_sqrt", "\\sqrt{","}", 6);
	...
	(void) new KileAction::Tag(i18n("Left-Right ()- \\left(..\\right)"), i18n("Left-Right ()"), KShortcut(), receiver, SLOT(insertTag(const KileAction::TagData&)), ac,"tag_leftright", "\\left(  \\right)", QString(), 7);
